...
|---|---|---|---|
| `web-qa` | AI-assisted web QA — drives real user journeys in a headless browser and judges whether the goal was achieved | `github:mrskwiw/web-qa` | ✅ live |
| `web-replicate` | Reconstruction-grade rebuild blueprints for web apps (sibling of web-qa) | `github:mrskwiw/web-replicate` | ✅ live |
...
`web-qa`, `web-replicate`, and `claude-novel-writer` are live and install cleanly.
One item remains:

- **`vibe-testing` and `repl-scratchpad`** are currently published in a *cross-platform
